...
{
    public partial class UserControl_Page2_2 : UserControl
    {
        public UserControl_Page2_2()
        {
            InitializeComponent();
        }

        private void UserControl_Page2_2_Load(object sender, EventArgs e)
        {
            Thread thread1 = new Thread(new ThreadStart(Uc2_2LifeProcess));
        ...
        private void Uc2_2LifeProcess()
        {
            while (true)
            {
                ...
                //系统状态
                controlHelper.UpdateRedByVariable("pictureBox18", "AutoSamplingStopped");
