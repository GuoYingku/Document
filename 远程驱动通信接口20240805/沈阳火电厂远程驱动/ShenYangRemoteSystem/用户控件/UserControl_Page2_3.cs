...
{
    public partial class UserControl_Page2_3 : UserControl
    {
        public UserControl_Page2_3()
        {
            InitializeComponent();
        }

        private void UserControl_Page2_3_Load(object sender, EventArgs e)
        {
            Thread thread1 = new Thread(new ThreadStart(Uc2_3LifeProcess));
        ...
        private void Uc2_3LifeProcess()
        {
            while (true)
            {
                ...
                //系统状态
                controlHelper.UpdateRedByVariable("pictureBox86", "Motor3");
